...
build_time_vars = {'ABIFLAGS': '',
 ...
 'BASECPPFLAGS': '',
 'BASEMODLIBS': '',
 'BINDIR': '/opt/_internal/cpython-3.11.10/bin',
 'BINLIBDEST': '/opt/_internal/cpython-3.11.10/lib/python3.11',
 ...
 'CONFIG_ARGS': "'CFLAGS_NODIST=-g -O2 -Wall -fdebug-prefix-map=/=. "
                ...
                "-Wl,-z,now' '--prefix=/opt/_internal/cpython-3.11.10' "
                "'--disable-shared' '--with-ensurepip=no' "
                "'--with-openssl=/opt/_internal/openssl-3.0' "
                "'--with-openssl-rpath=auto' "
                "'PKG_CONFIG_PATH=/usr/local/lib/pkgconfig' "
                "'TCLTK_LIBS=-ltk8.6 -ltcl8.6'",
 'CONFINCLUDEDIR': '/opt/_internal/cpython-3.11.10/include',
 'CONFINCLUDEPY': '/opt/_internal/cpython-3.11.10/include/python3.11',
 'COREPYTHONPATH': '',
 'COVERAGE_INFO': '/Python-3.11.10/coverage.info',
 'COVERAGE_LCOV_OPTIONS': '--rc lcov_branch_coverage=1',
 'COVERAGE_REPORT': '/Python-3.11.10/lcov-report',
 ...
 'DESTDIRS': '/opt/_internal/cpython-3.11.10 '
             '/opt/_internal/cpython-3.11.10/lib '
             '/opt/_internal/cpython-3.11.10/lib/python3.11 '
             '/opt/_internal/cpython-3.11.10/lib/python3.11/lib-dynload',
 'DESTLIB': '/opt/_internal/cpython-3.11.10/lib/python3.11',
 'DESTPATH': '',
 'DESTSHARED': '/opt/_internal/cpython-3.11.10/lib/python3.11/lib-dynload',
 'DFLAGS': '',
 'DIRMODE': 755,
 ...
 'INCLDIRSTOMAKE': '/opt/_internal/cpython-3.11.10/include '
                   '/opt/_internal/cpython-3.11.10/include '
                   '/opt/_internal/cpython-3.11.10/include/python3.11 '
                   '/opt/_internal/cpython-3.11.10/include/python3.11',
 'INCLUDEDIR': '/opt/_internal/cpython-3.11.10/include',
 'INCLUDEPY': '/opt/_internal/cpython-3.11.10/include/python3.11',
 ...
 'LDVERSION': '3.11',
 'LIBC': '',
 'LIBDEST': '/opt/_internal/cpython-3.11.10/lib/python3.11',
 'LIBDIR': '/opt/_internal/cpython-3.11.10/lib',
 ...
 'LIBOBJDIR': 'Python/',
 'LIBOBJS': '',
 'LIBPC': '/opt/_internal/cpython-3.11.10/lib/pkgconfig',
 'LIBPL': '/opt/_internal/cpython-3.11.10/lib/python3.11/config-3.11-x86_64-linux-gnu',
 'LIBPYTHON': '',
 ...
 'MACHDEP': 'linux',
 'MACHDEP_OBJS': '',
 'MACHDESTLIB': '/opt/_internal/cpython-3.11.10/lib/python3.11',
 'MACOSX_DEPLOYMENT_TARGET': '',
 'MAINCC': 'gcc -pthread',
 'MAJOR_IN_MKDEV': 0,
 'MAJOR_IN_SYSMACROS': 0,
 'MAKESETUP': './Modules/makesetup',
 'MANDIR': '/opt/_internal/cpython-3.11.10/share/man',
 ...
 'MODULE__HASHLIB_LDFLAGS': '-L/opt/_internal/openssl-3.0/lib  '
                            '-Wl,--enable-new-dtags,-rpath=/opt/_internal/openssl-3.0/lib  '
                            '-lcrypto',
 ...
 'MODULE__SSL_LDFLAGS': '-L/opt/_internal/openssl-3.0/lib  '
                        '-Wl,--enable-new-dtags,-rpath=/opt/_internal/openssl-3.0/lib '
                        '-lssl -lcrypto',
 ...
 'OBJECT_OBJS': '\\',
 'OPENSSL_INCLUDES': '-I/opt/_internal/openssl-3.0/include',
 'OPENSSL_LDFLAGS': '-L/opt/_internal/openssl-3.0/lib',
 ...
 'RETSIGTYPE': 'void',
 'RUNSHARED': '',
 'SCRIPTDIR': '/opt/_internal/cpython-3.11.10/lib',
 'SETPGRP_HAVE_ARG': 0,
 'SHELL': '/bin/sh',
 ...
 'VERSION': '3.11',
 'WASM_ASSETS_DIR': './opt/_internal/cpython-3.11.10',
 'WASM_STDLIB': './opt/_internal/cpython-3.11.10/lib/python3.11/os.py',
 'WHEEL_PKG_DIR': '',
 'WINDOW_HAS_FLAGS': 1,
 ...
 'abs_builddir': '/Python-3.11.10',
 'abs_srcdir': '/Python-3.11.10',
 'datarootdir': '/opt/_internal/cpython-3.11.10/share',
 'exec_prefix': '/opt/_internal/cpython-3.11.10',
 'prefix': '/opt/_internal/cpython-3.11.10',
 'srcdir': '.'}
